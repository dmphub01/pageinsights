var url="http://52.221.231.42:9500/"
...
.controller('homectrl',['$scope','$http','$location','$cookies',function($scope,$http,$location,$cookies,$localStorage,$interval){
	...
	var  mobile_div="background-image:url(./images/mobile1.png); height: 409px; width: 306px;";
		...
		else
		{
			...
			.success(function(res){
				...
				console.log( scoreJSON);
						...
						var  mobile_div="background-image:url(./images/mobile1.png);height: 247px;width:292px;background-repeat: no-repeat;background-size: 60%;";
					  $scope.div=mobile_div;
					  var mobile_h="175px";
					  var mobile_w="98px";
					  ...
					  $scope.imgpath=b.path;
					  localStorage.setItem('path', $scope.imgpath);
					  
                       $scope.type="Mobile";
                                              
console.log(desktopScore.formattedResults.ruleResults.EnableGzipCompression)
    ...
    //checking for OptimizeImages
     ...
     var OptimizeImages=desktopScore.formattedResults.ruleResults.OptimizeImages;
       ...
       if(OptimizeImages.urlBlocks[i].urls!=undefined)
       {
        ...
        for(var j=0;j<OptimizeImagesUrlLen;j++)
        {
         if(OptimizeImages.urlBlocks[i].urls[j].result!=undefined)
         {
          ...
          if(OptimizeImages.urlBlocks[i].urls[j].result.args!=undefined)
          {
           ...
           for (var k=0;k<desk_agrs_len;k++)
           {
            ...
            else
            {
             ...
             console.log("Desktop optimize images No Values")
          ...
          {
           console.log("Desktop optimize images No arguments");
      ...
      {
       console.log("Desktop optimize images are not available in OptimizeImages")
      }
					...
					var MainResourceServerResponseTime=desktopScore.formattedResults.ruleResults.MainResourceServerResponseTime;
							...
							if(MainResourceServerResponseTime.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<resourceLen;j++)
								{
									if(MainResourceServerResponseTime.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(MainResourceServerResponseTime.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<desk_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Desktop MainResourceServerResponseTime  No Values")
										...
										{
											console.log("Desktop MainResourceServerResponseTime No arguments");
									...
									{
										console.log("Desktop MainResourceServerResponseTime No urls")
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Desktop MainResourceServerResponseTime")
					 }
				...
				//checking for LeverageBrowserCaching
					...
					var LeverageBrowserCaching=desktopScore.formattedResults.ruleResults.LeverageBrowserCaching;
							...
							if(LeverageBrowserCaching.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<resourceLen;j++)
								{
									if(LeverageBrowserCaching.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(LeverageBrowserCaching.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<desk_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Desktop LeverageBrowserCaching  No Values")
										...
										{
											console.log("Desktop LeverageBrowserCaching No arguments");
									...
									{
										console.log("Desktop LeverageBrowserCaching No urls")
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Desktop LeverageBrowserCaching")
					 }									
					...
					var MinimizeRenderBlockingResources=desktopScore.formattedResults.ruleResults.MinimizeRenderBlockingResources;
							...
							if(MinimizeRenderBlockingResources.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<resourceLen;j++)
								{
									if(MinimizeRenderBlockingResources.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(MinimizeRenderBlockingResources.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<desk_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Desktop MinimizeRenderBlockingResources  No Values")
										...
										{
											console.log("Desktop MinimizeRenderBlockingResources No arguments");
									...
									{
										console.log("Desktop MinimizeRenderBlockingResources No urls")
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Desktop MinimizeRenderBlockingResources")
					 }								
     ...
     var MinifyCss=desktopScore.formattedResults.ruleResults.MinifyCss;
       ...
       if(MinifyCss.urlBlocks[i].urls!=undefined)
       {
        ...
        for(var j=0;j<MinifyCssLenUrlLen;j++)
        {
         if(MinifyCss.urlBlocks[i].urls[j].result!=undefined)
         {
          ...
          if(MinifyCss.urlBlocks[i].urls[j].result.args!=undefined)
          {
           ...
           for (var k=0;k<desk_agrs_len;k++)
           {
            ...
            else
            {
             ...
             console.log("Desktop MinifyCss  No Values")
          ...
          {
           console.log("Desktop MinifyCss No arguments");
      ...
      {
       console.log("Desktop MinifyCss are not available in OptimizeImages")
      }
     ...
     var MinifyHTML=desktopScore.formattedResults.ruleResults.MinifyHTML;
       ...
       if(MinifyHTML.urlBlocks[i].urls!=undefined)
       {
        ...
        for(var j=0;j<MinifyHTMLLenUrlLen;j++)
        {
         if(MinifyHTML.urlBlocks[i].urls[j].result!=undefined)
         {
          ...
          if(MinifyHTML.urlBlocks[i].urls[j].result.args!=undefined)
          {
           ...
           for (var k=0;k<desk_agrs_len;k++)
           {
            ...
            else
            {
             ...
             console.log("Desktop MinifyHTML  No Values")
          ...
          {
           console.log("Desktop MinifyHTML No arguments");
      ...
      {
       console.log("Desktop MinifyHTML are not available in OptimizeImages")
      }
					...
					var EnableGzipCompression=desktopScore.formattedResults.ruleResults.EnableGzipCompression;
							...
							if(EnableGzipCompression.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<EnableGzipCompressionUrlLen;j++)
								{
									if(EnableGzipCompression.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(EnableGzipCompression.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<desk_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Mobile EnableGzipCompression No Values")
										...
										{
											console.log("Mobile EnableGzipCompression No arguments");
									...
									{
										console.log("Mobile EnableGzipCompression No urls")
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Mobile EnableGzipCompression")
					 }
             ...
             Desktop_Data={"OptimizeImages":OptimizeImages_array,
				...
				//checking for OptimizeImages
					...
					var OptimizeImages=scoreJSON.formattedResults.ruleResults.OptimizeImages;
							...
							if(OptimizeImages.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<OptimizeImagesUrlLen;j++)
								{
									if(OptimizeImages.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(OptimizeImages.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<desk_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Mobile optimize images No Values")
										...
										{
											console.log("Mobile optimize images No arguments");
									...
									{
										console.log("Mobile optimize images No urls")
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Mobile OptimizeImages")
					 }
													

                      console.log("Mobile_OptimizeImages:-"+Mobile_OptimizeImages_array);
					...
					var MainResourceServerResponseTime=scoreJSON.formattedResults.ruleResults.MainResourceServerResponseTime;
							...
							if(MainResourceServerResponseTime.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<resourceLen;j++)
								{
									if(MainResourceServerResponseTime.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(MainResourceServerResponseTime.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<desk_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Mobile MainResourceServerResponseTime  No Values")
										...
										{
											console.log("MObile MainResourceServerResponseTime No arguments");
									...
									{
										console.log("Mobile MainResourceServerResponseTime No urls")
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Mobile MainResourceServerResponseTime")
					 }


					 console.log("Mobile_MainResourceServerResponseTime"+Mobile_MainResourceServerResponseTime_array);
				...
				//checking for LeverageBrowserCaching
					...
					var LeverageBrowserCaching=scoreJSON.formattedResults.ruleResults.LeverageBrowserCaching;
							...
							if(LeverageBrowserCaching.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<resourceLen;j++)
								{
									if(LeverageBrowserCaching.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(LeverageBrowserCaching.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<desk_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Mobile LeverageBrowserCaching  No Values");
										...
										{
											console.log("Mobile LeverageBrowserCaching No arguments");
									...
									{
										console.log("Mobile LeverageBrowserCaching No urls");
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Mobile LeverageBrowserCaching");
					 }									
													
										 console.log("LeverageBrowserCaching"+Mobile_LeverageBrowserCaching_array);		
					...
					var MinimizeRenderBlockingResources=scoreJSON.formattedResults.ruleResults.MinimizeRenderBlockingResources;
							...
							if(MinimizeRenderBlockingResources.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<resourceLen;j++)
								{
									if(MinimizeRenderBlockingResources.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(MinimizeRenderBlockingResources.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<desk_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Mobile MinimizeRenderBlockingResources  No Values")
										...
										{
											console.log("Mobile MinimizeRenderBlockingResources No arguments");
									...
									{
										console.log("Mobile MinimizeRenderBlockingResources No urls")
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Mobile MinimizeRenderBlockingResources")
					 }			
					 


 console.log("Mobile_MinimizeRenderBlockingResources"+Mobile_MinimizeRenderBlockingResources_array)
                       ...
                       else
                       {
                       		...
                       		console.log("Mobile_OptimizeImages no values");
                       ...
                       else
                       {
                       		...
                       		console.log("Mobile_MainResourceServerResponseTime no values");
                       ...
                       else
                       {
                       		...
                       		console.log("Mobile_LeverageBrowserCaching no values");
						   ...
						   if(Mobile_MinimizeRenderBlockingResources_array!="")
							{
							 ...
							 $scope.heading4=Mobile_MinimizeRenderBlockingResources_name;
							  ...
							  collapseThree = document.getElementById("collapseFour");
								  ...
								  //$scope.fix1=Mobile_OptimizeImages_array;
                       ...
                       else
                       {
                       		...
                       		console.log("Mobile_MinimizeRenderBlockingResources_ no values");
					...
					var MinifyCss=scoreJSON.formattedResults.ruleResults.MinifyCss;
							...
							if(MinifyCss.urlBlocks[i].urls!=undefined)
							{
								...
								for(var j=0;j<MinifyCssUrlLen;j++)
								{
									if(MinifyCss.urlBlocks[i].urls[j].result!=undefined)
									{
										...
										if(MinifyCss.urlBlocks[i].urls[j].result.args!=undefined)
										{
											...
											for (var k=0;k<Mobile_agrs_len;k++)
											{
												...
												else
												{
													...
													console.log("Mobile MinifyCss No Values")
										...
										{
											console.log("Mobile MinifyCss No arguments");
									...
									{
										console.log("Mobile MinifyCss No urls")
									}
								}
							}
						}
					 ...
					 {
						 console.log("urlBlocks are not available in Mobile MinifyCss")
					 }
       ...
       console.log("Desktop MinifyHTML are not available in OptimizeImages")
					  ...
					  if(Mobile_MinifyHTML_array!="")
                       ...
                       else
                       {
                       		...
                       		console.log("Mobile_MinifyHTML_ no values");
...
// Mobile button working....
                   ...
                   var show="Show how to fix";
                       ...
                       else
                       {
                       		...
                       		console.log("Mobile_MinifyCss_ no values");
                       ...
                       else
                       {
                       		...
                       		console.log("Mobile_EnableGzipCompression_ no values");
	...
	$scope.desktopScore=function(){
		...
		var  desk_div="background-image:url(./images/492-imacframe2.png); height: 250px; width:305px;";
			  $scope.div=desk_div;
			   ...
			   var show="Show how to fix";
					 ...
					 if(Desktop_Data.MinifyCss!="")
						...
						else
						{
								...
								console.log("Desktop MinifyCss_ no values");
						...
						else
						{
								...
								console.log("Desktop MinifyHTML_ no values");
						...
						else
						{
								...
								console.log("Desktop EnableGzipCompression_ no values");
